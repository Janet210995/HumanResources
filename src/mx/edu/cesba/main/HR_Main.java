...
public class HR_Main {
    ...
    public static void main(String[] args) {
        ...
        e1.setphoneNumber(Integer.parseInt(JOptionPane.showInputDialog("Ingrese un número telefónico")));
        e1.setsalary (Double.parseDouble(JOptionPane.showInputDialog("Ingrese su salario mensual")));
        e1.sethiredate(JOptionPane.showInputDialog("Ingrese la Fecha de contratación"));
